...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__card__ = __webpack_require__(479);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_event_event__ = __webpack_require__(71);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__providers_language_language__ = __webpack_require__(29);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var CardPage = (function () {
    function CardPage(prof, stripe, lp, settings, http, eProvider, platform, nav, navParams, loadingCtrl, alertCtrl, formBuilder) {
        this.prof = prof;
        this.stripe = stripe;
        this.lp = lp;
            ...
            window.window.PaystackPlugin.chargeCard(function (resp) {
                ...
                _this.eProvider.UpdateCard(card, month, year, cvc, amount, email, driverPay).then(function (success) {
                    _this.prof.UpdatePaymentType(2).then(function (suc) {
                        _this.showPayMentAlert(_this.lp.translate()[0].cardsuc, "", true);
                    });
                }).catch(function (error) {
                });
                //  });
            }, function (resp) {
                _this.showPayMentAlert(_this.lp.translate()[0].cardunc, "", false);
            }, {
                cardNumber: card,
                expiryMonth: month,
                expiryYear: year,
