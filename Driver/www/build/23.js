...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__addphotoinfo__ = __webpack_require__(480);
...
var AddphotoinfoPageModule = (function () {
    function AddphotoinfoPageModule() {
    }
    return AddphotoinfoPageModule;
}());
AddphotoinfoPageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["L" /* NgModule */])({
        declarations: [
            __WEBPACK_IMPORTED_MODULE_2__addphotoinfo__["a" /* AddphotoinfoPage */]
        ],
        imports: [
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__addphotoinfo__["a" /* AddphotoinfoPage */])
        ],
        entryComponents: [
            __WEBPACK_IMPORTED_MODULE_2__addphotoinfo__["a" /* AddphotoinfoPage */]
        ]
...
//# sourceMappingURL=addphotoinfo.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AddphotoinfoPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(17);
...
var AddphotoinfoPage = (function () {
    function AddphotoinfoPage(navCtrl, http, lp, settings, actionSheetCtrl, pop, ph, camera, loadingCtrl) {
    ...
    AddphotoinfoPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad AddphotoinfoPage');
        // this.pop.hideLoader()
    };
    AddphotoinfoPage.prototype.Next = function () {
    ...
    AddphotoinfoPage.prototype.choosePic_2 = function () {
        var _this = this;
    ...
    AddphotoinfoPage.prototype.capture2 = function () {
        var _this = this;
        var options = {
            quality: 40,
            targetWidth: 300,
    ...
    AddphotoinfoPage.prototype.capture2FromFile = function () {
        var _this = this;
        var options = {
            quality: 40,
            targetWidth: 300,
    ...
    AddphotoinfoPage.prototype.processLicensePicture = function (captureData) {
        var _this = this;
        ...
        imageRef.putString(captureData, __WEBPACK_IMPORTED_MODULE_5_firebase_app__["storage"].StringFormat.DATA_URL).then(function (snapshot) {
            imageRef.getDownloadURL().then(function (url) {
                _this.ph.UpdateLPhotoInfo(url).then(function (success) {
                    ...
                    _this.navCtrl.setRoot('Addphoto2Page');
                }).catch(function (error) { _this.pop.alertMe('Check Your Internet Connection and try again'); });
            }).catch(function (error) { _this.pop.alertMe('Check Your Internet Connection and try again'); });
        }).catch(function (error) { _this.pop.alertMe('Check Your Internet Connection and try again'); });
    };
    return AddphotoinfoPage;
}());
AddphotoinfoPage = __decorate([
...
//# sourceMappingURL=addphotoinfo.js.map
